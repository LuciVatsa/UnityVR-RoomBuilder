...
public class RamSpline : MonoBehaviour
{
    ...
    public float terrainDepthHeight = 0;
    public float terrainDepthMultiplier = 1;
    ...
    public void GenerateMeshParts(Mesh baseMesh)
    {
        ...
        for (int i = 0; i < meshPartsCount; i++)
        {
            ...
            meshRendererPart.receiveShadows = false;
            meshRendererPart.shadowCastingMode = UnityEngine.Rendering.ShadowCastingMode.Off;
