Shader "NatureManufacture Shaders/Trees/Cross Model Shader Seasons"
{
	Properties
	{
		...
		[NoScaleOffset]_MainTexAutumn("MainTex Autumn", 2D) = "white" {}
	...
	SubShader
	{
		...
		uniform sampler2D _MainTexAutumn;
		...
		void surf( Input i , inout SurfaceOutputStandardSpecular o )
		{
			...
			float2 uv_MainTexAutumn169 = i.uv_texcoord;
			float clampResult167 = clamp( ( _Season - 2.0 ) , 0.0 , 1.0 );
			float4 lerpResult168 = lerp( tex2DNode2 , tex2D( _MainTexAutumn, uv_MainTexAutumn169 ) , clampResult167);
			...
			float4 lerpResult56 = lerp( ( lerpResult168 * _HealthyColor ) , ( tex2D( _SnowAlbedoRGB, uv_SnowAlbedoRGB ) - float4( appendResult76 , 0.0 ) ) , lerpResult150);
