...
import com.viveport.myapplication.R;
...
public class NavigationDrawerFragment extends Fragment {
    ...
    public NavigationDrawerFragment() {
        ...
        // Adding child data
        listDataHeader.add("Top Level APIs");
        listDataHeader.add("DRM");
        listDataHeader.add("User Profile");
        listDataHeader.add("IAP");
        listDataHeader.add("IAP Subscription");
        listDataHeader.add("Stats");
        listDataHeader.add("Achievement");
...
//        listDataChild.put(listDataHeader.get(2), comingSoon);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mExpandableListAdapter = new ExpandableListAdapter(getContext(), listDataHeader, listDataChild);
